...
const TermsAndConditions: React.FC = () => {
  ...
  const handleEmailClick = () => {
    window.location.href = 'mailto:dhudaramsonsorganic@rajyadu.in?subject=Terms & Conditions Inquiry&body=Hi Rajyadu Team,';
  };

  const handleCallClick = () => {
    window.location.href = 'tel:+918003845358';
  };
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400">dhudaramsonsorganic@rajyadu.in</p>
                      </div>
                    </div>
