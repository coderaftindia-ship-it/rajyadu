...
export const sampleProducts: Product[] = [
  {
    ...
    category: "skincare",
    subcategory: "serums",
    imageUrls: ["https://images.unsplash.com/photo-1620916566398-39f1143ab7be?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=400"],
    rating: "4.6",
    reviewCount: 2847,
    inStock: true,
    featured: true,
  ...
  },
  {
    ...
    imageUrls: ["https://images.unsplash.com/photo-1556228720-195a672e8a03?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=400"],
    rating: "4.4",
    reviewCount: 1523,
    inStock: true,
    featured: false,
